...
messages = [
    (
        "system",
        f"You are a helpful assistant. You can answer questions using context inside ```...```. \nContext\n{context}",
    )
]


while True:
    user_message=input("Tu pregunta: ")
    messages.append(("human", user_message ))
    ai_msg = llm.invoke(messages)
    print("IA: ",ai_msg.content)
    print("Token usage: ",ai_msg.response_metadata.get('token_usage'))
